...
function compare(a, b)
    ...
    c.bench_function("ffi raw", |ben| {
        ben.iter(|| unsafe {
            let val = lua
                .exec_raw::<LuaValue>((cmp_ref.clone(),), |state| {
...
criterion_group!(lua_ffi_cast, ffi_raw, ffi_cast, ffi_type);
criterion_main!(lua_ffi_cast);
